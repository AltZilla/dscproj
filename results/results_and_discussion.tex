...
Kim, Oh, Noh et al., ``Energy-Efficient Online Federated Learning in Wireless Networks,'' \textit{IEEE Transactions on Vehicular Technology}, 2026.
...
Wu, Li, Guo et al., ``A Weight-Allocation and Privacy-Preserving Federated Learning Approach for the BTM PV Power Forecasting,'' \textit{IEEE Transactions on Sustainable Energy}, 2026.

\bibitem{dong2020energy}
Fu, Ku, Singh et al., ``Energy-Efficient User Grouping-Based Federated Learning with UAV Assistance,'' \textit{IEEE Transactions on Green Communications and Networking}, 2026.

\bibitem{alzamil2025federated}
Charatsaris, Voikos, Diamanti et al., ``Latency and Energy Minimization in RIS-enabled AirComp Federated Learning Networks,'' \textit{IEEE Transactions on Vehicular Technology}, 2026.
...
Li, Hu, Wang et al., ``PoFEL: Energy-efficient Consensus for Blockchain-based Hierarchical Federated Learning,'' \textit{IEEE Transactions on Services Computing}, 2026.

\bibitem{zhang2025demand}
Chavhan, Santo, Gupta et al., ``Energy-Aware Sparse Federated Learning Framework for Secure Edge Healthcare and Consumer IoMT Devices,'' \textit{IEEE Transactions on Consumer Electronics}, 2026.

\bibitem{bahrami2021deep}
Ji, Li, Lai et al., ``Redundancy Removal and Knowledge Alignment-Based Personalized Federated Learning for Online Condition Monitoring,'' \textit{IEEE Transactions on Neural Networks and Learning Systems}, 2026.

\bibitem{mao2023communication-efficient}
Zhang, Xie, Hao et al., ``Optimizing Demand Response in Virtual Power Plants: A Two-Stage Game-Programming Model,'' \textit{IEEE Transactions on Engineering Management}, 2026.

\bibitem{huang2019demand}
Yang, Zhu, Zou et al., ``Reconfigurable Intelligent Surface Assisted Anti-Jamming Communications: A Stackelberg Game Approach,'' \textit{IEEE Transactions on Vehicular Technology}, 2026.
...
Zhou, Guo, Yu et al., ``Three-Stage Stackelberg Game-Based Federated Learning With Wireless Power Transfer,'' \textit{IEEE Transactions on Networking}, 2026.
...
Tang, Ma, Li et al., ``Active RIS-Aided Anti-Jamming Wireless Communications: A Stackelberg Game Perspective,'' \textit{IEEE Transactions on Communications}, 2026.
...
Sheng, Xu, Xie et al., ``Risk-Aware Prediction-Optimization Integrated Method for Day-ahead Microgrid Operation,'' \textit{IEEE Transactions on Smart Grid}, 2026.

\bibitem{lee2018light-weight}
Ommani, Delkhosh, Seifi et al., ``Optimization-Based Data Recovery After False Data Injection Attacks on State Estimators Using Measurements Inertia and Calibrated Predictions,'' \textit{IEEE Transactions on Smart Grid}, 2026.

\bibitem{tang2024dynamic}
Guillen, Milanovi\u0107 et al., ``Machine Learning-Based Long-Term Forecasting of Load Composition Considering Exogenous Variables,'' \textit{IEEE Transactions on Smart Grid}, 2026.
