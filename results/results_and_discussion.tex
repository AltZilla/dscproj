...
\begin{itemize}
    ...
    \item We design a hierarchical Stackelberg game with a time-varying strategy, coupled with federated forecast results, to establish a closed-loop demand-response market system that can derive optimal equilibrium prices for electricity.

    \item We apply a severely restricted multi-objective DE optimizer (DE/rand/1/bin) that assesses a customized fitness function consisting of eight criteria to accomplish simultaneous peak shaving, thermal comfort maintenance, and constraint satisfaction.

    \item We build a sophisticated digital twin simulator, capable of modeling stochastic Markov-based occupant dynamics and complicated thermal behavior, specifically intended for simulating a massive amount of synthetic data to test the joint optimization framework.
\end{itemize}
...
A wide variety of approaches have been proposed in the areas of smart home energy management, forecasting demands, and privacy-preserving automation. Recently, researchers have suggested a plethora of methods including but not limited to reinforcement learning and spatiotemporal federated setups, each focusing on different aspects of this multidimensional problem \cite{rahman2025electrical, zhang2025adaptive}. This section provides an overview and critique of relevant studies published in 2024--2026 according to the principal algorithmic families involved.
...
\includegraphics[width=\textwidth]{graphs/system_architecture.pdf}
...
In this paper, we have proposed a novel intelligent hybrid approach that is designed to tackle all the above mentioned complexities associated with energy management of smart homes. 
